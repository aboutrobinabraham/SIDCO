...
public class Test_Product extends BaseClass {
	...
	public void login() throws InterruptedException
	{
        ...
        softAssert.assertTrue(loginPage.verifyLogin(),"failed to login the user " + email );
	...
	public void testSearch() throws InterruptedException
	{
	    ...
	    softAssert.assertTrue(result, "Search verification failed for product: " + product);
	...
	public void brandNameVerification() throws InterruptedException {
		...
		softAssert.assertEquals(ActualBrandName,ExpectedBrandName , "Brand is different");
		softAssert.assertEquals(ActualProductName,ExpectedProductName , "Product is different");
	...
	public void testFilter() throws InterruptedException
	{
		...
		softAssert.assertTrue(pg.Verifyfilter(), "Search verification failed for product: " + Filter);
	...
	public void testAddtoCart() throws InterruptedException
	{
		...
		softAssert.assertEquals(pg.VerifyCart(),AddedProduct,"Product not added to Cart: " + AddedProduct );
	...
	public void testCheckOut() throws InterruptedException
	{
		...
		softAssert.assertEquals(pg.verifyPayment(),"Pay Now","Proceed to payment online failed" );
